...
public class GraphViz {
	...
	/**
	 * The image size in dpi. 96 dpi is normal size. Higher values are 10% higher
	 * each. Lower values 10% lower each.
	 * 
	...
	private File writeDotSourceToFile(String str) throws java.io.IOException {
		File temp;
		try {
			File f = new File(GraphViz.TEMP_DIR);
			temp = File.createTempFile("dorrr", ".dot", f);
	...
	/**
	 * Takes the cluster or subgraph id as input parameter and returns a string that
	 * is used to start a subgraph.
	 * 
